 ...
 * 전국 일반음식점 인허가 정보를 직접 가져옵니다. 실제 발급받은 서비스키로 응답을 확인하고
 * 필드명을 검증했습니다(2026-08-19, 샘플 조회 결과 기준). (예전에 별도 소스였던
 * localdata.go.kr은 2026-04-16 폐쇄되어 lib/localdata.ts와 함께 2026-08-24 제거했습니다 — 이
 * 공공데이터포털 API가 그 역할을 대신합니다.)
 *
