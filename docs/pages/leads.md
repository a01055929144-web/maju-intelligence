...
## LAST VERIFIED
2026-09-21 — 초기 리드 요청 우선 처리, 검색·추천·견적 일괄 작업 진행 표시, 모바일/PC 반응형 레이아웃을 점검했다.
...
- [x] 첫 화면 리드 요청과 보조 소스 요청을 분리하고 실패 시 화면 안에서 재시도
- [x] 영업리드 탐색·추천 점수·검색량 산정·견적 일괄 기록의 단계별 진행 상태 표시
- [x] 모바일 및 1366/1920px 폭에서 툴바, 지도, 가로 스크롤 목록 레이아웃 보강
